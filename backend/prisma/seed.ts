...
async function main() {
  ...
  // 4. 12 Comprehensive Purifiers across Campus
  ...
  const aiSamples = [
    ...
    {
      purifierCode: 'WP-006',
      detectedObject: 'Unknown Contaminant',
      confidence: 78.9,
      riskLevel: 'WARNING',
      recommendation: 'Extract physical water sample for laboratory spectrometry verification.',
      hoursAgo: 22,
      boundingBox: [{ x: 180, y: 130, w: 140, h: 120, label: 'Particulate Aggregate (78.9%)' }],
      status: 'REVIEWED',
    },
    {
      purifierCode: 'WP-001',
    ...
    },
    {
      ...
      confidence: 97.4,
      riskLevel: 'SAFE',
      recommendation: 'Normal clean baseline verified.',
      hoursAgo: 10,
      boundingBox: [],
      status: 'RESOLVED',
    },
    {
      ...
      confidence: 99.8,
      riskLevel: 'SAFE',
      recommendation: 'Ultra-pure optical clarity verified in analytical lab unit.',
      hoursAgo: 16,
      boundingBox: [],
      status: 'RESOLVED',
    },
  ...
  console.log('✅ Seed completed successfully with 12 purifiers and full realistic datasets!');
}
